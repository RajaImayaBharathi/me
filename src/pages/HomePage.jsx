...
const HomePage = () => {
  ...
  return (
    <React.Fragment>
      <div className="min-h-screen-minus-100 mt-[64px] pt-[64px] lg:mt-0 flex items-center justify-center " id="home" >
        <div className="">
          <p className="WelcomeText text-white font-HomeSection" ref={RightSlide}>
            Hello Everyone 👋, My name is
          </p>
          <p className="NameText text-0xl text-white bold font-HomeSection" ref={RightSlide}>
            <span>Raja Imaya Bharathi</span>
          </p>

          
          <div className="pb-3 pt-2 socialIconsInMobile lg:hidden flex-row text-white font-Navbar">
            <a
              href="https://github.com/RajaImayaBharathi"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <img src="HomeImg.png" className="HomeImg1 mx-auto" alt="" ref={RightSlide} />
          <p className="mt-2 subPara1 text-white text-justify" ref={RightSlide}>
            {`I'm an India-based software developer with a goal-driven creative
            mindset and a passion for learning and innovating.`}
          </p>
          <p className="subPara2 mt-9 text-white text-justify" ref={RightSlide}>
            I specialize in building{" "}
            <span className="text-highlightOne">
              robust backends, sleek frontends
            </span>
          ...
          <button className="HomeBtn mt-20">Hire me??</button>
        </div>
        <div className="ml-20 HomeImg" ref={DownSlide}>
          <img src="HomeImg.png" className="HomeImg" alt="" />
        </div>
